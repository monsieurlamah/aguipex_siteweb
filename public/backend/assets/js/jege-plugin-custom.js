...
/** Sweet Alert Library - Jege **/
  ...
  initSliders: function() {
    // Sliders for jege purpose in refine cards section
  ...
  initDashboardPageCharts: function() {
    ...
    myChart = new Chart(ctx, {
      type: 'line',
      data: {
        labels: ["Jan", "Fév", "Mar", "Avr", "Mai", "Jun", "Juil", "Août", "Sep", "Oct"],
        datasets: [{
          label: "Active Users",
          borderColor: "#6bd098",
          pointRadius: 0,
    ...
    gradientFill = ctx.createLinearGradient(0, 170, 0, 50);
    gradientFill.addColorStop(0, "rgba(128, 182, 244, 0)");
    gradientFill.addColorStop(1, "rgba(24, 206, 15, 1)");
...
/** Multi-steps wizard **/
 ...
 /** Charts dashborad and Map Chart JS **/

 $(document).ready(function() {
      // Javascript method's body
      jege.initDashboardPageCharts();


      jege.initVectorMap();

      jege.checkFullPageBackgroundImage();
