            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group" role="group"><a class="btn btn-success" role="button"
                            href="{{ route('service_bas.create') }}"><i
                                class="fas fa-plus-circle"></i>&nbsp;<strong>&nbsp;</strong>Ajouter une mission</a></div>
                ...
                <div class="col col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Toutes les missions</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped table-hover table-bordered display nowrap"
                                    ...
                                    <tbody>
                                        @forelse ($services_bas as $service)
                                            ...
                                            <td>
                                                <a href="{{route('service_bas.edit', $service->id)}}"><i class="fa fa-edit"></i></a>
                                            </td>
                                            <td><a href="{{route('service_bas.delete', $service->id)}}"><i class="fa fa-trash"></i></a></td>
                                            <td align="center">
                                                <a href="{{route('service_bas.detail', $service->id)}}"><button type="button"
                                        ...
                                        @empty
                                            <td class="text-center" colspan="7">Aucun service du bas de slide trouvé</td>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
