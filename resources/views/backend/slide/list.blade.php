            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group" role="group"><a class="btn btn-success" role="button"
                            href="{{ route('slide.create') }}"><i
                                class="fas fa-plus-circle"></i>&nbsp;<strong>&nbsp;</strong>Ajouter un slide</a></div>
                ...
                <div class="col col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Tous les slides d'accueil</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse ($slides as $slide)
                                            <tr style="text-align:center">
                                                <td>{{ $slide->numero }}</td>
                                                @if ($slide->image)
                                                <td><img src="{{asset('assets/slides/'.$slide->image)}}" height="50"
                                                ...
                                                <td>{{ $slide->libelle }}</td>
                                                <td><span
                                                        class="badge badge-pill badge-success">{{ $slide->status }}</span>
                                                </td>
                                                <td>
                                                    <a href="{{route('slide.edit', $slide->id)}}"><i class="fa fa-edit"></i></a>

                                                </td>
                                                <td><a href="{{route('slide.delete', $slide->id)}}"><i class="fa fa-trash"></i></a></td>
                                                <td align="center">
                                                    <a href="{{route('slide.detail', $slide->id)}}"><button type="button"
                                        ...
                                        @empty
                                            <td class="text-center" colspan="9">Aucun slide trouvé</td>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
