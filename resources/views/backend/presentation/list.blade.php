            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group" role="group"><a class="btn btn-success" role="button"
                            href="{{ route('presentation.create') }}"><i
                                class="fas fa-plus-circle"></i>&nbsp;<strong>&nbsp;</strong>Ajouter une presentation</a></div>
                ...
                <div class="col col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Toutes les presentations</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse ($presentations as $presentation)
                                            <tr style="text-align:center">
                                                ...
                                                <td><span
                                                    class="badge badge-pill badge-success">{{ $presentation->status }}</span>
                                            </td>
                                            <td>
                                                <a href="{{route('presentation.edit', $presentation->id)}}"><i class="fa fa-edit"></i></a>
                                            </td>
                                            <td><a href="{{route('presentation.delete', $presentation->id)}}"><i class="fa fa-trash"></i></a></td>
                                            
                                            </tr>

                                        @empty
                                            <td class="text-center" colspan="4">Aucune presentation trouvée</td>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
