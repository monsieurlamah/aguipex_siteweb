                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5 class="text-success font-weight-bolder">Modification du departement</h5>
                            </div>
                            <div class="card-body">
                                <form>
                                    <!-- Start: Row -->
                                            ...
                                            <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text input-group-prepend"><span
                                                        ...
                                                        name="name" value="{{ $departement->name }}"
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-lg-6"><button class="btn btn-primary btn btn-success mx-1"
                                            type="submit">Modifier</button><a href="{{route('departement.index')}}"
