            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group" role="group"><a class="btn btn-success" role="button"
                            href="{{ route('statistique.create') }}"><i
                                class="fas fa-plus-circle"></i>&nbsp;<strong>&nbsp;</strong>Ajouter une statistique</a></div>
                ...
                <div class="col col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Toutes les statistiques</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @forelse ($statistiques as $statistique)
                                            <tr style="text-align:center">
                                                ...
                                                <td>{{ $statistique->title }}</td>
                                                <td>{{ $statistique->number }}</td>
                                                <td><span
                                                    class="badge badge-pill badge-success">{{ $statistique->status }}</span>
                                            </td>
                                            <td>
                                                <a href="{{route('statistique.edit', $statistique->id)}}"><i class="fa fa-edit"></i></a>
                                            </td>
                                            <td><a href="{{route('statistique.delete', $statistique->id)}}"><i class="fa fa-trash"></i></a></td>
                                            
                                            </tr>

                                        @empty
                                            <td class="text-center" colspan="6">Aucune statistique trouvée</td>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
