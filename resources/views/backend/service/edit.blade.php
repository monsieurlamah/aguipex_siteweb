                    ...
                    <div class="col-lg-12">
                        <div class="card h-100">
                            <div class="card-header">
                                <h5 class="text-success font-weight-bolder">Modification de service</h5>
                            </div>
                            <div class="card-body">
                                <form>
                                    <!-- Start: Row -->
                                            ...
                                            <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text input-group-prepend"><span
                                                        ...
                                                        name="title" placeholder="Titre du service..." value="{{$service->title}}">
                                                    @error('title')
                                            ...
                                            <div class="form-group"><label class="form-label"
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text input-group-prepend"><span
                                                        ...
                                                        name="icone" placeholder="Icône du service..." value="{{$service->icone}}">
                                                    @error('icone')
                                                        <div class="text-danger"> <strong>{{ $message }}</strong></div>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class="col-lg-12 pr-1">
                                            <div class="form-outline">
                                                ...
                                                <textarea class="form-control" id="textAreaExample1" name="description" placeholder="Entrer une description..."
                                                    rows="4" value="{{ old('description') }}">{{$service->description}}</textarea>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    <div class="col-lg-6"><button class="btn btn-primary btn btn-success mx-1"
                                            type="submit">Modifier</button><a href="{{route('service.create')}}"
