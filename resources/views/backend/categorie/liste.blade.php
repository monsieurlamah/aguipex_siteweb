            ...
            <div class="row">
                <div class="col">
                    <div class="btn-group" role="group"><a class="btn btn-success" role="button"
                            href="{{ route('categorie.create') }}"><i
                                class="fas fa-plus-circle"></i>&nbsp;<strong>&nbsp;</strong>Ajouter une catégorie</a></div>
                                    ...
                                    <tbody>
                                        @forelse ($categories as $categorie)
                                            <tr style="text-align:center">
                                                ...
                                                <td><span
                                                    class="badge badge-pill badge-success">{{ $categorie->status }}</span>
                                            </td>
                                            <td>
                                                <a href="{{route('categorie.edit', $categorie->id)}}"><i class="fa fa-edit"></i></a>
                                            </td>
                                            <td><a href="{{route('categorie.delete', $categorie->id)}}"><i class="fa fa-trash"></i></a></td>
                                            
                                            </tr>

                                        @empty
                                            <td class="text-center" colspan="4">Aucune catégorie trouvée</td>
                                        @endforelse
                                    </tbody>
                                </table>
                            </div>
