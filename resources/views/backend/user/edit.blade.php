            ...
            <div class="col-lg-12">
                <div class="card h-100">
                            ...
                            <div class="row row">
                                <div class="col-lg-6 pr-1">
                                    <div class="form-group"><label class="form-label" for="nomDeLaBanque">Nom</label>
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></div><input class="form-control form-control" type="text" name="name" value="{{$user->name}}" placeholder="Nom">
                                        </div>
                                    </div>
                                    @error('name')
                                ...
                                <div class="col-lg-6 pr-1">
                                    <div class="form-group"><label class="form-label" for="nomDeLaBanque">Prénom</label>
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></div><input class="form-control form-control" type="text" name="first_name" value="{{$user->first_name}}" placeholder="Prénom">
                                        </div>
                                    </div>
                                    @error('first_name')
                                    <div class="text-danger"> <strong>{{ $message }}</strong>
                                ...
                                <div class="col-lg-6 pr-1">
                                    <div class="form-group"><label class="form-label" for="nomDeLaBanque">Email</label>
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-envelope"></i></span></div><input class="form-control form-control" type="email" name="email" value="{{$user->email}}" placeholder="Email">
                                        </div>
                                    </div>
                                    @error('email')
                                    <div class="text-danger"> <strong>{{ $message }}</strong>
                                ...
                                <div class="col-lg-6 pr-1">
                                    <div class="form-group"><label class="form-label" for="nomDeLaBanque">Tel</label>
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-phone"></i></span></div><input class="form-control form-control" type="tel" name="phone" value="{{$user->phone}}" placeholder="Tel">
                                        </div>
                                    </div>
                                    @error('phone')
                                    <div class="text-danger"> <strong>{{ $message }}</strong>
                                ...
                                <div class="col-lg-6 pr-1">
                                    <div class="form-group"><label class="form-label" for="nomDeLaBanque">Adresse</label>
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-map-marked"></i></span></div><input class="form-control form-control" type="text" name="address" value="{{$user->address}}" placeholder="Adresse">
                                        </div>
                                    </div>
                                    @error('address')
                                    <div class="text-danger"> <strong>{{ $message }}</strong>
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text input-group-prepend"><span class="input-group-text"><i class="fas fa-user"></i></span></div><select class="form-select" name="apRole">
                                                <optgroup label="Rôle">
                                                    ...
                                                    <option value="COM">Communication</option>
                                                    <option value="MARKETING">Marketing</option>
                                                    <option value="STATIC" selected>Certification</option>
                                                    @endif
                                                </optgroup>
                                            </select>
                                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row"> 
                            <div class="col-lg-6"><button class="btn btn-primary btn btn-success mx-1" type="submit">Modifier</button><a href="{{route('user.index')}}" class="btn btn-primary btn btn-primary mx-1" type="submit">Annuler</a></div>
                        </div>
                    </div>
                </div>
            </div><!-- End: Column -->
